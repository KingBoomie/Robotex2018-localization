...
while True:
    ...
    rvec, tvec, _objPoints = cv2.aruco.estimatePoseSingleMarkers(corners, MARKER_SIZE_REAL_FIELD, camera_matrix, distortion_coefficients)
        ...
        for i in range(len(rvec)):
            if ids[i] in marker_ids_to_detect:
                ...
                if ids[i] == 22:
                    ...
                    #cv2.putText(field, "rot: " + str(marker_angle_from_camera*angle_const*180/3.141592) + " deg", (30, 30), cv2.FONT_HERSHEY_COMPLEX, 1, 0)
                    # cv2.putText(field, "rot: " + str(angle * angle_const * 180 / 3.141592) + " deg", (30, 30), cv2.FONT_HERSHEY_COMPLEX, 1, 0)
                    ...
                    field = getFieldWithPoint(pointx, pointy)
